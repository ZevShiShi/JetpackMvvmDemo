...
public class MultiLanguageUtils {
    ...
    public static void changeLanguage(Context context, String language, String area) {
        if (TextUtils.isEmpty(language) && TextUtils.isEmpty(area)) {
            //如果语言和地区都是空，那么跟随系统s
            AppPrefsUtils.INSTANCE.putString(BaseConstant.LOCALE_LANGUAGE, "");
            AppPrefsUtils.INSTANCE.putString(BaseConstant.LOCALE_COUNTRY, "");
            Locale newLocale = new Locale("zh", "CN");
            changeAppLanguage(context, newLocale, false);
        } else {
...
//        String spLanguage = (String) AppPrefsUtils.INSTANCE.getString(BaseConstant.LOCALE_LANGUAGE);
//        String spCountry = (String) AppPrefsUtils.INSTANCE.getString(BaseConstant.LOCALE_COUNTRY);
//        Resources resources = context.getResources();
...
//    }
    ...
    public static boolean isSameWithSetting(Context context) {
        ...
        String sp_language = AppPrefsUtils.INSTANCE.getString(BaseConstant.LOCALE_LANGUAGE);
        String sp_country = AppPrefsUtils.INSTANCE.getString(BaseConstant.LOCALE_COUNTRY);
...
//    }
    ...
    public static void saveLanguageSetting(Locale locale) {
        LogUtils.d("LANGUAGE=" + locale.getLanguage() + ",COUNTRY=" + locale.getCountry());
        AppPrefsUtils.INSTANCE.putString(BaseConstant.LOCALE_LANGUAGE, locale.getLanguage());
        AppPrefsUtils.INSTANCE.putString(BaseConstant.LOCALE_COUNTRY, locale.getCountry());
    }
...
//    }
    ...
    public static Application.ActivityLifecycleCallbacks callbacks = new Application.ActivityLifecycleCallbacks() {
        ...
        public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
            String language = AppPrefsUtils.INSTANCE.getString(BaseConstant.LOCALE_LANGUAGE);
            String country = AppPrefsUtils.INSTANCE.getString(BaseConstant.LOCALE_COUNTRY);
...
//                Locale locale = new Locale("zh", "CN");
                changeLanguage(activity, language, country);
                LogUtils.d("ActivityLifecycleCallbacks=============中文");
            }
        }
